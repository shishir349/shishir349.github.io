...
function googleTranslateElementInit() {
 ...
 <div class="container">
        ...
        <div align="center">
            ...
            <button class="btn btn-default filter-button" data-filter="sensors">Sensors</button>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sensors">
                <img src="images/raspberrypi.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sensors">
                <img src="images/hygrometer-1.jpg" class="img-responsive">
            </div>
